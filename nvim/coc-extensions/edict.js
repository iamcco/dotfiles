...
function getWordByIndex(word, idx) {
                ...
                case 3:
                    context.subscriptions.push(coc_nvim_1.languages.registerHoverProvider(['*'], {
                        provideHover: function (document, position) {
                            ...
                            var wordText = document.getText(wordRange) || '';
                            var word = wordText;
                            if (!word) {
                                return null;
                            }
                            var words = ecdictData.get(word.toLowerCase());
                            if (!words) {
                            ...
                            var values = formatDoc(word, words);
                            return {
                                contents: {
